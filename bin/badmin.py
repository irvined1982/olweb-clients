...
phclose.add_argument("host_names", nargs='*', type=str, default=None,
                     help='Specify the names of any server hosts or host groups.  All batch server hosts will be \
                     closed if the reserved word all is specified.')
...
phopen.add_argument("host_names", nargs='*', type=str, default=None,
                    help='Specify the names of any server hosts or host groups.  All batch server hosts will be closed \
                    if the reserved word all is specified.')
...
pqopen.add_argument("queue_names", nargs='*', type=str, default=None,
                    help='Opens specified queues, or all queues if the reserved word all is specified. If no queue is \
...
pqclose.add_argument("queue_names", nargs='*', type=str, default=None,
                     help='Closes specified queues, or all queues if the reserved word all is specified. If no queue \
                     is specified, the system default queue is assumed.')
...
pqinact.add_argument("queue_names", nargs='*', type=str, default=None,
                     help='Inactivates specified queues, or all queues if the reserved word all is specified. If no \
                     queue is specified, the system default queue is assumed.')
...
pqact.add_argument("queue_names", nargs='*', type=str, default=None,
                   help='Activates specified queues, or all queues if the reserved word all is specified. If no queue \
                   is specified, the system default queue is assumed.')
